...
class CommonCommands:
    ...
    def calculate_pp(self,message):
        ...
        if mode == 'osu':
            response = response + " | aim: " + str(round(difficulty.aim,2)) + " | speed: " + str(round(difficulty.speed,2)) + " | fl: " + str(round(difficulty.flashlight,2)) + " | slider factor: " + str(round(difficulty.slider_factor,2)) + " | speed note: " + str(round(difficulty.speed_note_count,2)) + " | ar: " + str(round(attributes.ar,2)) + " | cs: " + str(round(attributes.od,2)) + " | od: " + str(round(attributes.od,2)) + " | hp: " + str(round(attributes.hp,2)) + " | bpm: " + str(round(attributes.bpm,2)) + " | pp: " + str(round(perfomance.pp)) + ' | pp acc: ' + str(round(perfomance.pp_acc)) + ' | pp aim: ' + str(round(perfomance.pp_aim)) + ' | pp speed: ' + str(round(perfomance.pp_speed)) + ' | pp fl: ' + str(round(perfomance.pp_flashlight))
        else:
